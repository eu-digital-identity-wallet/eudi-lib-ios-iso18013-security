...
public final class InMemoryP256SecureArea: SecureArea, @unchecked Sendable {
    ...
    public func signature(id: String, algorithm: MdocDataModel18013.SigningAlgorithm, dataToSign: Data, keyUnlockData: Data?) throws -> Data {
        let signature = (try key.signature(for: dataToSign)).rawRepresentation
        return signature
    }

    public func keyAgreement(id: String, publicKey: MdocDataModel18013.CoseKey, keyUnlockData: Data?) throws -> SharedSecret {
